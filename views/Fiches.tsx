    ...
    <div className="max-w-7xl mx-auto px-4 py-12 space-y-16">
      <header className="text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-stone-400 font-black uppercase text-[10px] tracking-[0.4em]">Protocole Royal <span className="normal-case font-sans">BɔɔnSphere</span></p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {INITIAL_TERMS.map((fiche, index) => (
          <TermCard key={fiche.id} term={fiche} index={index} />
        ))}
      </div>
